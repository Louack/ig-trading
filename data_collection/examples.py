...
def example_custom_alert_handler():
    ...
    def send_to_telegram(alert):
        ...
        logger.info(f"Would send to Telegram: {alert['severity']} - {alert['error_message']}")
...
def example_data_validation():
    ...
    from data_collection.interfaces.market_data import MarketData, MarketDataPoint, PriceData
