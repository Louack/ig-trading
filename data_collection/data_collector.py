...
class DataCollector:
    ...
    def collect_data_for_symbol(
        ...
        try:
            ...
            if market_data:
                logger.info(
                    f"Collected {len(market_data)} data points for {symbol} ({timeframe}) from {source.name}"
                )
                return market_data
            else:
    ...
    def collect_and_store(
        self, symbol: str, timeframe: str, source_name: Optional[str] = None
    ) -> bool:
        """
