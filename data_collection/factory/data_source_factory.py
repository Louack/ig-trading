...
class DataSourceFactory:
    ...
    def create_data_source(cls, source_type: str, config: Dict[str, Any]) -> DataSource:
        ...
        if source_type not in cls._sources:
            ...
            raise ValueError(f"Unsupported data source type: {source_type}. Available: {available_sources}")
    ...
    @classmethod
    def create_multi_source(cls, configs: Dict[str, Dict[str, Any]]) -> Dict[str, DataSource]:
        """
