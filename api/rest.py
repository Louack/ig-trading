...
from core.exceptions import (
    IGAPIError, IGAuthenticationError, IGAuthorizationError, IGValidationError,
    IGRateLimitError, IGNotFoundError, IGServerError, IGNetworkError, 
    IGTimeoutError, IGErrorType
)
